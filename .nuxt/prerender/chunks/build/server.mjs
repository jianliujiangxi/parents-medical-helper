import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, defineComponent, shallowRef, h, resolveComponent, getCurrentScope, computed, unref, useSSRContext, ref, createApp, mergeProps, provide, shallowReactive, isVNode, createCommentVNode, withCtx, createTextVNode, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, Suspense, defineAsyncComponent, toRef, isRef, Fragment, isReadonly, isShallow, isReactive, toRaw } from 'file:///home/lj/githubs/parents-medical-helper/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/lj/githubs/parents-medical-helper/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///home/lj/githubs/parents-medical-helper/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///home/lj/githubs/parents-medical-helper/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/lj/githubs/parents-medical-helper/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file:///home/lj/githubs/parents-medical-helper/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, parseURL, encodePath, decodePath, isScriptProtocol, withQuery, withTrailingSlash, withoutTrailingSlash } from 'file:///home/lj/githubs/parents-medical-helper/node_modules/ufo/dist/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///home/lj/githubs/parents-medical-helper/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-eDQDwUPd.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-vk3Q31OJ.mjs')
  },
  {
    name: "result",
    path: "/result",
    component: () => import('./result-Bv_Y_e7l.mjs')
  },
  {
    name: "wizard",
    path: "/wizard",
    component: () => import('./wizard-nHXigyKZ.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import('./privacy-B4aBB8Ip.mjs')
  },
  {
    name: "sources",
    path: "/sources",
    component: () => import('./sources-BDIf-Q0C.mjs')
  },
  {
    name: "guide-slug",
    path: "/guide/:slug()",
    component: () => import('./_slug_-_KRQOGZs.mjs')
  }
];
...
function useElderMode() {
  const elderMode = useState("elder-mode", () => false);
  return { elderMode };
}
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  __name: "ElderModeToggle",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        class: "ghost-button",
        type: "button"
      }, _attrs))}>${ssrInterpolate(unref(elderMode) ? "退出长辈模式" : "👴 长辈模式")}</button>`);
    };
  }
});
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ElderModeToggle.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_ElderModeToggle = _sfc_main$4;
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/sources" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createTextVNode("官方依据")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(ssrRenderComponent(_component_ElderModeToggle, null, null, _parent));
  _push(`</nav></header>`);
}
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["app-shell", { "elder-mode": unref(elderMode) }]
      }, _attrs))}>`);
      _push(ssrRenderComponent(_component_SiteHeader, null, null, _parent));
      _push(`<main class="page-wrap">`);
      _push(ssrRenderComponent(_component_NuxtPage, null, null, _parent));
      _push(`</main><footer class="footer"><p>免费、无需注册、不收集身份证/医保号。仅做办事导航，不替代医保经办机构审核。</p><p>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DdPXDqeq.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Cru0h6yq.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useRouter as b, createError as c, entry_default as default, tryUseNuxtApp as t, useRoute as u };
