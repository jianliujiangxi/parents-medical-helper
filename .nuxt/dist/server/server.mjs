import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, h, resolveComponent, computed, unref, mergeProps, useSSRContext, withCtx, createTextVNode, provide, ref, isVNode, createCommentVNode, Suspense, Fragment, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "/home/lj/githubs/parents-medical-helper/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/lj/githubs/parents-medical-helper/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/lj/githubs/parents-medical-helper/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/home/lj/githubs/parents-medical-helper/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu } from "/home/lj/githubs/parents-medical-helper/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/home/lj/githubs/parents-medical-helper/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-eDQDwUPd.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-vk3Q31OJ.js")
  },
  {
    name: "result",
    path: "/result",
    component: () => import("./_nuxt/result-Bv_Y_e7l.js")
  },
  {
    name: "wizard",
    path: "/wizard",
    component: () => import("./_nuxt/wizard-nHXigyKZ.js")
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import("./_nuxt/privacy-B4aBB8Ip.js")
  },
  {
    name: "sources",
    path: "/sources",
    component: () => import("./_nuxt/sources-BDIf-Q0C.js")
  },
  {
    name: "guide-slug",
    path: "/guide/:slug()",
    component: () => import("./_nuxt/_slug_-_KRQOGZs.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DdPXDqeq.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Cru0h6yq.js"));
